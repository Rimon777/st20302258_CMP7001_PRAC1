...
public class SystemManager {
    ...
    public void addWalkInCustomer(String name, String email, String phone, String regNumber, String make, String model) {
        Customer customer = new Customer(customers.size() + 1, name, email, phone, false);
        customers.add(customer);
    ...
    public void allocateTask(int mechanicId, String regNumber, String description, int priority) {
    ...
    public void markTaskAsComplete(int taskId) throws NotFoundException {
        // Find the task by ID
        Task task = findTaskById(taskId);
